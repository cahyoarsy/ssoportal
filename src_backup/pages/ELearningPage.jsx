...
export default function ELearningPage({ 
  ...
  const handleModuleClick = (moduleId) => {
    ...
    if (moduleId === 'elearning-iml') {
      // Open dedicated IML page
      if (onOpenIMLPage) {
        onOpenIMLPage();
      }
    } else if (onModuleSelect) {
      // For other modules, show coming soon or redirect to module
      if (moduleId === 'elearning-iml') {
            ...
            {filteredModules.map((module, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* Action Button */}
                  <div className="mt-6">
                    <button className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white py-3 px-4 rounded-lg font-medium hover:from-blue-600 hover:to-indigo-600 transition-all duration-200 group-hover:shadow-lg">
