        ...
        <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Portal Single Sign On untuk platform terpadu pembelajaran dan penelitian teknik kelistrikan.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              {[
                ...
                { icon: '⚡', text: 'Electrical Engineering' },
                { icon: '🎓', text: 'E-Learning' },
                { icon: '📊', text: 'Research Platform' }
              ].map((feature, index) => (
                <motion.div
                  key={feature.text}
          ...
          >
            ...
            <div className="bg-white/10 backdrop-blur-2xl rounded-3xl border border-white/20 shadow-2xl p-8 relative overflow-hidden">
              ...
              <div className="relative text-center mb-8">
                ...
                <p className="text-white/80">Masuk ke Portal Sangsongko Engineering</p>
              </div>
